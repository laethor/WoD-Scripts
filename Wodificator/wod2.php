...
$races = array( "Asynchrone","Dinturan","Drakénoide", "Elfe Mag-Mor", "Elfe Tirem-Ag", "Frontalier", "Gnome", "Homme des bois","Kaern", "Kérasi", "Nain des collines", "Nain des montagnes","Nymphe","Oxendéen", "Rashani", "Semi-homme",);
...
if (isset($_POST['talents']) and !empty($_POST['talents'])) {
   ...
   $race_stats['Asynchrone'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 1+($niv * .15), 'distance' =>   1+($niv * .15), 'magie'    => 0, 'social'   => -2 - ($niv * .30),'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 2+($niv * .30), 'maladie' => 0 , 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0 ));
  
   $race_stats['Dinturan'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 2+($niv * .30), 'distance' =>   0, 'magie'    => -2 - ($niv * .30), 'social'   => 0, 'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 2+($niv * .30), 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0 )));
  
   $race_stats['Drakénoide'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 0, 'distance' =>   -1-($niv * .15), 'magie'    => 2+($niv * .30), 'social'   => -1 - ($niv * .15),'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 0 , 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 0 , 'projection' => 2+($niv * .30) ));
  
  $race_stats['Elfe Mag-Mor'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 1+($niv * .15), 'distance' =>   1+($niv * .15), 'magie'    => -1 - ($niv * .15), 'social'   =>-1 - ($niv * .15),'force de la nature' => 0, 'embuscade' => 1+($niv * .15), 'declenchement' => 0, 'maladie' => 0 , 'explosion' => 1+($niv * .15), 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0 ));
  
  $race_stats['Elfe Tirem-Ag'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 0, 'distance' =>   -1-($niv * .15), 'magie'    => 2+($niv * .30), 'social'   => 0, 'explosion' => 2+($niv * .30),'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 0, 'maladie' => -1 - ($niv * .15), 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0  ));
   
   $race_stats['Frontalier'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 1+($niv * .15), 'distance' =>  0, 'magie'    => -2-($niv * .30), 'social'   => 1+($niv * .15),'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 0 , 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 2+($niv * .30), 'projection'=> 0  ));

	$race_stats['Gnome'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => -1-($niv * .15), 'distance' =>   1+($niv * .15), 'magie'    =>  1+($niv * .15), 'social'   =>0,'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 0 , 'explosion' => 0, 'desorientation'=> 0, 'effroi' => -1 - ($niv * .15) , 'projection' => 2+($niv * .30)));
	
	$race_stats['Homme des bois'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 0, 'distance' =>   2+($niv * .30), 'magie'    => -1-($niv * .15), 'social'   => -1 - ($niv * .15), 'force de la nature' => 2+($niv * .30), 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 0 , 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0 ));
	
	$race_stats['Kaern'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 0, 'distance' =>   -1-($niv * .15), 'magie'    => 0, 'social'   => 0, 'maladie' => 1+($niv * .15),'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 0 ,  'explosion'   => -1 - ($niv * .15), 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0 ));
	
	$race_stats['Kérasi'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 1+($niv * .15), 'distance' =>   -1-($niv * .15), 'magie'    => -1-($niv * .15), 'social'   =>  1+($niv * .15), 'force de la nature' => 1+($niv * .15), 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 0 , 'explosion' => 0, 'desorientation'=> 0,'effroi' => 1+($niv * .15), 'projection'=> 0  ));
	
	$race_stats['Nain des collines'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 1+($niv * .15), 'distance' =>  -2-($niv * .30), 'magie'    => 0, 'social'   => 1+($niv * .15), 'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 2+($niv * .30) , 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0 ));
	
	$race_stats['Nain des montagnes'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => 1+($niv * .15), 'distance' =>   -1-($niv * .15), 'magie'    => 1+($niv * .15), 'social'   =>  -1-($niv * .15), 'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 1+($niv * .15), 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 1+($niv * .15) , 'projection'=> 0  ));
	
	$race_stats['Nymphe'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => -1-($niv * .15), 'distance' =>  -1-($niv * .15), 'magie'    =>0, 'social'   =>  2+($niv * .30),'force de la nature' => 2+($niv * .30), 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 0 , 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0));
	
	$race_stats['Oxendéen'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => -1-($niv * .15), 'distance' =>  0, 'magie'    => 2+($niv * .30), 'social'   => -1-($niv * .15),'force de la nature' => 0, 'embuscade' => 2+($niv * .30), 'declenchement' => 0, 'maladie' => 0 , 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0  ));
	
	$race_stats['Rashani'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    =>-2-($niv * .25), 'social'   => 0),
    'def' => array( 'melee'    => 1+($niv * .15), 'distance' =>  0, 'magie'    =>1+($niv * .15), 'social'   => -2-($niv * .30),'force de la nature' => 0, 'embuscade' => 0, 'declenchement' => 0, 'maladie' => 0 , 'explosion' => 0, 'desorientation' => 2+($niv * .30), 'effroi' => 0 , 'projection'=> 0  ));
	
	 $race_stats['Semi-homme'] = array(
    'att' => array( 'melee'    => 0, 'distance' => 0, 'magie'    => 0, 'social'   => 0),
    'def' => array( 'melee'    => -1-($niv * .15), 'distance' =>   0, 'magie'    => -1 - ($niv * .15), 'social'   =>2+($niv * .30), 'force de la nature' => 1+($niv * .15), 'embuscade' => 0, 'declenchement' => 1+($niv * .15), 'maladie' => 0 , 'explosion' => 0, 'desorientation'=> 0, 'effroi' => 0 , 'projection'=> 0 , ));
  ...
  $race_stats = array(
	'def' => array(
		...
		'FdN' 	=> $race_stats[$race]['def']['force de la nature'] + (.75 * $skills['Veinard']) + (1.25 * $skills['Proche de la nature']),
		'Emb' 	=> $race_stats[$race]['def']['embuscade'] + (.75 * $skills['Veinard']) + (1.25 * $skills['Sixième sens']),
		'Piè'	=> $race_stats[$race]['def']['declenchement'] + (.75 * $skills['Veinard']) + (1.25 * $skills['Sixième sens']),
		'Mal' 	=> $race_stats[$race]['def']['maladie'] + (.75 * $skills['Veinard']) + (1.25 * $skills['Tenace']),
		'Exp'	=> $race_stats[$race]['def']['explosion'] + (.75 * $skills['Veinard']),
		'Dés'	=> $race_stats[$race]['def']['desorientation'] + (.75 * $skills['Veinard']),
		'Eff' 	=> $race_stats[$race]['def']['effroi'] + (.75 * $skills['Veinard']),
		'Pré'	=> $race_stats[$race]['def']['projection'] + (.75 * $skills['Veinard']) + (1.25 * $skills['Petite personne']),
